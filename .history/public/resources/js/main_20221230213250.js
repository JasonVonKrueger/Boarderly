        ...
        switch(e.key) {
            case 'ArrowDown':
                if (document.activeElement.id === 'sidebar') {
                    if (getActiveSidebarButton() === 'nav_home') {
                        triggerEvent(document.getElementById('nav_pictures'), 'click')
                    }

                    if (getActiveSidebarButton() === 'nav_pictures') {
                        triggerEvent(document.getElementById('nav_games'), 'click')
                    }
                    
                }
                //let next = __sidebar.firstChild.id
                //alert(document.activeElement.id)
                //triggerEvent(document.getElementById(next), 'click')
            case 'ArrowUp':
                // do something;
        }      
    }
